...
The instructions are written for AI agents.  Please follow the exact instructions in the table below.  Once completed, compile the project and fix any symbol not found errors caused by missing namespaces.
