...
[assembly:Verb<int[], DefaultCommandAction<string>>("test assembly-verb-with-bad-arguments", Description = "The second generic argument is not a valid options class")]
