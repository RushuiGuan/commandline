...
[assembly:Verb<int[], DefaultCommandHandler<string>>("test assembly-verb-with-bad-arguments", Description = "The second generic argument is not a valid options class")]
